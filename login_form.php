						...
						$.ajax({
							...
							success: function(html) {
								if (html == 'true') {
									...
									$.jGrowl("Welcome to School of Technology- Njala University Learning Management System", {
			...
			<div id="button_form" class="form-signin">
				<B>New to SCHOOL OF TECHNOLOGY?</B>
				<hr>
				...
				<div class="pull-right">
					<button data-placement="top" title="Sign In as a Lecturer" id="signin_teacher" onclick="window.location='signup_teacher.php'" name="login" class="btn btn-info" type="submit">I`m a Lecturer</button>
				</div>
			</div>
			<script type="text/javascript">
				$(document).ready(function() {
