						...
						if (password == cpassword) {
							...
							$.ajax({
								...
								success: function(html) {
									if (html == 'true') {
										$.jGrowl("Welcome to School of Technology Learning Management System", {
										...
										$.jGrowl("student does not found in the database Please Sure to Check Your ID Number or Firstname, Lastname and the Class You Belong. ", {
